            ...
            {getFieldDecorator('registerPassword', {
              ...
              rules: [
                ...
                <Input
                    ...
                    maxLength={16}
                    placeholder='联系方式 (选填)'
                    addonBefore={<span className='iconfont icon-phone' style={focusItem === 1 ? styles.focus : {}}/>}/>
            )}
          </Form.Item>
            ...
            {getFieldDecorator('registerPassword', {
              ...
              rules: [
                ...
                <Input
                    ...
                    maxLength={16}
                    placeholder='电子邮箱 (选填)'
                    addonBefore={<span className='iconfont icon-email' style={focusItem === 1 ? styles.focus : {}}/>}/>
            )}
          </Form.Item>
